...
<script type="text/javascript">
    $(function () {
            ...
            $.each(msg, function (i, e) {
                ...
                if (e.child && e.child.length > 0) {
                    $.each(e.child, function (ci, ce) {
                        ...
                        menuList += "<li><div class=\"childMenu\"><cite></cite><span style=\"height: 16px;margin: 7px 0px 5px 0px;\"><img style=\"padding-bottom: 5px;\" src=\"resources/public/css/icons/" + ce.iconCls + ".png\"/></span><a href=\"javascript:void(0)\" target=\"rightFrame\" onclick=\"addTab('" + effort + "');return false;\">" + ce.name + "</a><i></i></div></li>";
                    });
                }
                menuList += "</ul></dd>";
            });
        ...
        request.fail(function (jqXHR, textStatus) {
            ...
            window.location.href = "<%=basePath%>";  //重新定位到登录主页面	
        });
...
<div id="menuAccordion" style="background: #f0f9fd; overflow: visible;"></div>