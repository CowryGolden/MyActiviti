	            		...
	            		success: function(data) {            			
	            			if(data.status) {		            				
	            				...
	            				if(pageFlag == "fromStuOverview") {  //从“学生概览”页面跳转而来，返回时重新返回该界面
	            					...
	            					window.location.href="<%=basePath%>zznueg/portal/teacherplatform/studentDetail?stuUserId=" + stuUserId + "&pageFlag=fromPdfViewer";
	            				}	            				
	            			}
	           			},
	           			error: function(data) {
					...
					<div id="toolbarContainer">
						<div id="toolbarViewer">
							<div id="toolbarViewerLeft">
								<button class="toolbarButton backButton" style="width: 45px;background-color: #3EAFE0;color: #fff;" onclick="goBack();">返回</button>
