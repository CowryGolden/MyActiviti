...
<script type="text/javascript">
    $(function () {
        ...
        $("#form").form({
            url: "manage/users/saveOrUpdateUserByUserType",
            onSubmit: function () {
                $.messager.progress({
                    title: '提示',
                    text: '数据处理中，请稍后....'
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 10px;">
        <form id="form" method="post">
            <fieldset>
                <legend><img src="resources/core/images/fromedit.png" style="margin-bottom: -3px;"/> 开设账户</legend>
                <input name="id" id="id" type="hidden"/>
                <input name="userId" id="userId" type="hidden"/>
                <input name="status" id="status" type="hidden"/>
                <!-- 用户类型字段虽然用户信息表中不存在，这个可以作为持久化用户时的依据 -->
                ...
                <table>
                    <tr>
                        ...
                        <td><input name="userName" id="userName" type="text" class="easyui-textbox easyui-validatebox"
                                   required="required" data-options="readonly:true" /></td>
                        <th>用户账号</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><textarea class="easyui-textbox" name="userDesc"
                                                  style="width: 435px;height: 100px;">后台开设账户</textarea></td>
                    </tr>
                </table>
            </fieldset>
        </form>
