...
<%--    <input name="tempId" id="tempId" type="hidden" value="<%=request.getParameter("tempId") %>"/>  --%> 
        <form id="form" method="post">
            <fieldset>
                <legend><img src="resources/core/images/fromedit.png" style="margin-bottom: -3px;"/> 学生编辑
                </legend>
                ...
                <table>
                	<tr>
                		<th>学生学号</th>
                        <td><input name="tsno" id="tsno" placeholder="请输入学生学号" class="easyui-textbox easyui-validatebox"
                                   type="text" required="required"/></td>
                        <th>学生姓名</th>
                        <td><input name="name" id="name" placeholder="请输入学生姓名" class="easyui-textbox easyui-validatebox"
                                   type="text" required="required"/></td>           
                	</tr>
                	<tr>
                        <th>性别</th>
